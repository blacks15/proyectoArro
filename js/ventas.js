$(document).ready(function(){
	global.validaSesion();
	global.cargaFolio('php/ventas.php','recuperaFolio');
...
/////////////////////////////////////////////////////////////
    ...
    **************************/
	...
	$("#btnSave").on('click',function(){
		//var cadena = $("#frmAgregarVenta").serialize();
...
/////////////////////////////////////////////////////////////
	...
	$("#codigoProducto1").on('keyup',function(evt){
		...
		if (charCode == 13 && $(this).val().length > 0) {
			var parametros = {opc: 'buscarProducto','buscar': $(this).val(),'tipoBusqueda':1 };
			...
			if (respuesta.codRetorno == '000') {
				...
				setTimeout(function() {
					...
					$("#precioProducto").val(respuesta.venta);
					$("#cantidadProducto").val(respuesta.stActual);
...
/////////////////////////////////////////////////////////////
	...
	function agregarGrid(){
		...
		$("#tabla").append("<tr id="+j+"><td width='20%'><p class='center' id=i"+j+">"+id+
			...
			</td><td><button type='button' class='icon-delProd btn red lighten-1 btnEliminar' data="+j+"></button>\
			</td></tr>"
		).show('fold',1000);
			//LLAMAR FUNCIONES
		limpiarCampos();
